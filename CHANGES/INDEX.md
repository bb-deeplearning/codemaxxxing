...
| `packages/opencode/src/server/server.ts`                                       | Modified | Forces the reload watcher's lazy runtime alive from `listen`                 |
