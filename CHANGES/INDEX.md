...
| File                                                                        | Status   | Changes                                                                                      |
| ---------------------------------------------------------------------------- | -------- | ---------------------------------------------------------------------------------------------- |
| `packages/core/src/util/effect-flock.ts` + test                              | Modified | `tryAcquire` (single attempt, `LockHeldError`, scoped release)                                 |
...
| File                                                                         | Status   | Changes                                                                                          |
| ---------------------------------------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------ |
| `packages/opencode/src/worktree/index.ts`                                    | Modified | Service rewrite: branch-optional `Info`, `list()`/`listAt()`, readiness contract (populate → include-copy → instance boot → start scripts → ready), disk ceiling, diff/merge/discard, dangling-commit discard snapshots, git anchored at primary cwd |
...
| `packages/opencode/test/project/worktree.test.ts`                            | Modified | 24 pins: readiness, include-copy, ceiling, discard snapshot, scoped-merge regression             |
