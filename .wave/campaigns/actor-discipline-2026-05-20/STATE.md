...
user_question: ""
loop_state: armed
active_session_id: ses_1bb107ffeffeCm3LeLCGwNum0t
...
| 4 | running  | ses_1bb107ffeffeCm3LeLCGwNum0t | — | ABORT protocol (Phase 2B): structured ABORT prose for subagents; control.ts recognition + spawner notification with structured payload; generalize wave's set-phrase exits across all subagents. INV-D-12..14. |
