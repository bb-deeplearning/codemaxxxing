...
| 6 | running  | ses_1bad425a0ffee9XS2fbYUNAC6d | — | Spawn pool (Phase 3B): spawn_pool primitive + collect strategies (all/first/any_n). Permission key consults task. INV-D-18..20. |
